...
class Pyanx(object):
    ...
    def add_node(self, entity_type='Anon', label=None, ring_color=None, description='', datestr=None,
    ...
    def __add_entities(self, chart):
        ...
        for data in self.nodes.values():
            ...
            chart_item = anx.ChartItem(XPosition=x, Label=data['label'], End=anx.End(X=x, Y=y, Entity=entity),
